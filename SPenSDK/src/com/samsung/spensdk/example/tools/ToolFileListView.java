...
public class ToolFileListView extends ListView {
	...
	public ToolFileListView(Context context, AttributeSet attrs, int defStyle){
		super(context, attrs, defStyle);		 
		init(context);
	}

	public ToolFileListView(Context context, AttributeSet attrs){
		super(context, attrs);		 
		init(context);
	}

	public ToolFileListView(Context context){
		super(context);		
		init(context);
	}
